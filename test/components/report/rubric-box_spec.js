...
describe("<RubricBox />", () => {
  ...
  describe("disabling non-applicable ratings", () => {
    it("should understand which rubric criteria are or are not applicable", () => {
      ...
      expect(migratedRubric.criteriaGroups[0].criteria[0].nonApplicableRatings[1]).toBe("R2");
  ...
  describe("converting markdown in description fields", () => {
    it("should convert to HTML", () => {
      ...
      expect(migratedRubric.criteriaGroups[0].criteria[0].description).toEqual(expect.stringContaining("_**supported by evidence**_"));
