...
context("Portal Dashboard Question Details Panel", () => { 
  context('View List By', () => {
    describe('verify by list by toggles switches views', () => {
      it('list by question', () => {
        ...
        cy.log("verify spotlight opens dialog when no student selected (default)");
  ...
  context('Activity nav area', ()=>{
    it('verify activity navigation is visible', ()=>{
      ...
      cy.log("verify activity nav buttons toggle activities");
      ...
      cy.log("verify toggling activity goes to the first question of the activity");
      ...
      cy.log("verify student navigation");
      ...
      cy.log("verify response section updates when student is navigated");
  ...
  context('Question nav area',()=>{
    ...
    it('verify title is correct', function() {
      ...
      cy.log("verify question text area is visible");
      ...
      cy.log("verify activity button opens activity page");
      ...
      cy.log("verify activity button opens teacher edition page");
  ...
  context('Student list and responses area', () => {
    ...
    it('verify student names are listed',()=>{
      ...
      cy.log("verify students with no answer cannot be selected");
      cy.get('[data-cy=spotlight-selection-checkbox]').eq(0).should("not.have.class","disabled");
    
      cy.log("verify spotlight students dialog is opened when students are selected and spotlight is clicked");
      ...
      cy.log("verify spotlight dialog elements");
      ...
      cy.log("verify color change button");
      ...
      cy.log("verify deselect student");
