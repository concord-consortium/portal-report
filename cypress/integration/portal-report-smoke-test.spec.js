...
context('Portal Report Smoke Test', () => {
    ...
    function getAnswerData(questionData) {
        ...
        if (answersData != null) {
            ...
            cy.log('There were no answers for the question')
        }
    }
    ...
    context('Module Details', () => {
        it('Verifies sequence name', () => {
            cy.get('@classData').then((classData) => {
                const moduleName = classData.report.name
    ...
    context('Activity Level', () => {
        ...
        it('Verifies activity Name', () => {
            cy.get('@classData').then((classData) => {
                const activityName = getActivityData(classData)[activityIndex].name
    ...
    context('Portal Report Settings', () => {
        ...
        it('Selects questions and shows selected (Activity 1)', () => {
            cy.get('@classData').then((classData) => {
                let pageData = getPageData(getActivityData(classData)[activityIndex])
                let checkboxCount = 0
                let questionData;
    ...
    context('Activity Level Feedback', () => {
        ...
        it('checks toggle for show all students', () => {
            cy.get('@classData').then((classData) => {
                let studentTotal = classData.class.students.length
