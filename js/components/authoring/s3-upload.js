      ...
      <div>
        <div className="s3Details">
          ...
          <div className="help">
            ...
            <a href="https://console.aws.amazon.com/iam/home#/groups/Rubric-S3-Access" target="_blank">
              https://console.aws.amazon.com/iam/home#/groups/Rubric-S3-Access
            </a>

            <p>
              It limits access to their own directory based on the username (IAM username and username
              on the authoring page have to match).
            </p>
          </div>
        </div>
      </div>
